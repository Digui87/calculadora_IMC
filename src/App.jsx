    ...
    return (
      ...
      <div className="app">
        <div className="area-input">
          ...
          <input type="text" placeholder='Peso em [KG]. Ex: 75' value={peso} onChange={(e) => setPeso(e.target.value)} />
          <input type="text" placeholder='Altura em [CM]. Ex: 170' value={altura} onChange={(e) => setAltura(e.target.value)} />
